...
class Beam {
    ...
    constructor(startX, startY, endX, endY, radius) {
        ...
        this.radius = radius;
        this.triangles = [];
        this.startPoint = mulS(fromOct(this.startX, this.startY), this.radius);
        this.endPoint = mulS(fromOct(this.endX, this.endY), this.radius);
            ...
            for (let x = 0; x < beamsPerSide; x++) {
                for (let ty = 0; ty < beamsPerSide; ty++) {
                    for (let tx = 0; tx < beamsPerSide; tx++) {
                        const beam = new Beam(x/beamsPerSide, y/beamsPerSide, tx/beamsPerSide, ty/beamsPerSide, Math.PI*radius/beamsPerSide);
